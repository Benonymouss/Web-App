...
<head>
    ...
    <link rel="stylesheet" href="styleeemplogin.css">
</head>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Bussiner Owners
                    </h2>
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Clients" name="clients">
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="Links" name="link">
                        </div>
                            


                        <div class="input-group">
                            <input class="input--style-1" type="file" placeholder="file" name="file">                        </div>
